...
ActiveRecord::Schema.define(version: 20170622111024) do
  ...
  create_table "answers", force: :cascade do |t|
    ...
    t.index ["rating"], name: "index_answers_on_rating", using: :btree
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.integer  "rating",     default: 0
    t.index ["rating"], name: "index_questions_on_rating", using: :btree
